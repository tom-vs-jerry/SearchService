...
{
    public class SensHighLighter
    {
        #region Private fields

        private int _FragmentSize = 50;
        private Formatter _Formatter;
        private Analyzers.SensTokenizer _Token;
        ...
        {
            ICollection<WordInfo> keywordsWordInfos = _Token.SegmentToWordInfos(keywords);
            ...
            ICollection<WordInfo> contentWordInfos = _Token.SegmentToWordInfos(content);
        ...
        public SensHighLighter(Formatter formatter,Analyzers.SensTokenizer token)
        {
