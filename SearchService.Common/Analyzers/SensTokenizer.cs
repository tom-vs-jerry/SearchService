...
namespace SearchService.Common.Analyzers
{
    ...
    /// 作者：Sofia
    /// </summary>
    public class SensTokenizer : Tokenizer
    {
        ...
        public SensTokenizer(System.IO.TextReader input, bool originalResult)
            : this(input)
        {
        ...
        public SensTokenizer(string segmentConfigPath)
        {
        ...
        public SensTokenizer(System.IO.TextReader input)
            : base(input)
        {
            lock (_LockObj)
            {
