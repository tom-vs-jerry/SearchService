...
using Segment.SegAnalyzer;
using Segment.Algorithm;
namespace Segment.HighLight
{
        ...
        public class Highlighter
        {
            ...
            private List<WordInfo> PickupKeywords(List<WordInfo> keywordsWordInfos, List<WordInfo> contentWordInfos)
            {
            ...
            {
                List<WordInfo> keywordsWordInfos = _KtToken.SegmentToWordInfos(keywords);
                ...
                List<WordInfo> contentWordInfos = _KtToken.SegmentToWordInfos(content);
            ...
            private string FragmentToString(Fragment fragment)
            {
                ...
                {
                    string temp = _Content.Substring(_Selection[i].Position, _Selection[i].Word.Length);
            ...
            public Highlighter(Formatter formatter, SegTokenizer ktToken)
            {
