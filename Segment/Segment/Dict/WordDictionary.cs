...
namespace Segment.Dict
{
    ...
    {
       public Dictionary<string, WordAttribute> _WordDict = new Dictionary<string, WordAttribute>();

       public Dictionary<char, WordAttribute> _FirstCharDict = new Dictionary<char, WordAttribute>();
       public Dictionary<uint, WordAttribute> _DoubleCharDict = new Dictionary<uint, WordAttribute>();
       public Dictionary<long, byte[]> _TripleCharDict = new Dictionary<long, byte[]>();
        ...
        public void Clear()
        {  
            _FirstCharDict.Clear();
             
            _DoubleCharDict.Clear();
            _TripleCharDict.Clear();
            _WordDict.Clear();
