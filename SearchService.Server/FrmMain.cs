...
namespace SearchService.Server
{
    public partial class FrmMain : Form
    {
        ...
        /// 锁定窗体实例
        /// </summary>
        private SLockedUI m_SLockedUI = null;
        #endregion
        ...
        /// 设置窗体
        /// </summary>
        private SSystemSet.SSystemSetUI m_SSystemSetUI = null;
        //文件信息
        ...
        private void toolBtnConfig_Click(object sender, EventArgs e)
        {
            ...
            {
                this.m_SSystemSetUI = new SSystemSet.SSystemSetUI();
        ...
        {
            SAboutUI _SAboutUI = new SAboutUI();
        ...
        SBatchInsert frmBatchInsert = new SBatchInsert();
        private void MenuBatch_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(path))
            {
                ...
                {
                    frmBatchInsert = new SBatchInsert();
                }
                frmBatchInsert.Show();
